...
object DistributeddatastoreService  {
  val TOPIC_NAME = "greetings"
}

/**
  * The distributed-datastore service interface.
  * <p>
  * This describes everything that Lagom needs to know about how to serve and
  * consume the DistributeddatastoreService.
  */
trait DistributeddatastoreService extends Service {
  ...
  override final def descriptor = {
    import Service._
    // @formatter:off
    named("distributed-datastore")
      .withCalls(
        pathCall("/api/hello/:id", hello _),
        pathCall("/api/hello/:id", useGreeting _)
      )
      .withTopics(
        topic(DistributeddatastoreService.TOPIC_NAME, greetingsTopic)
