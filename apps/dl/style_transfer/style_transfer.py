...
class StyleTransfer(object):
    def __init__(self, content_img, style_img, img_width, img_height):
        ...
        self.initial_img = self.content_img
    ...
    def _content_loss(self, P, F):
        ...
        """
        self.content_loss = tf.reduce_mean(tf.square(F - P)) / (4.0 * P.size)
    ...
    def _single_style_loss(self, a, g):
        ...
        return tf.reduce_sum(tf.square(G - A) / (tf.square(2.0 * N * M)))
    ...
    def _style_loss(self, A):
        ...
        self.style_loss = sum([self.style_layer_w[i] * E[i]
    ...
    def losses(self):
        with tf.variable_scope('losses'):
            ...
            self.total_loss = 1.0 / 20.0 * self.content_loss + 1.0 / 50.0 * self.style_loss
