...
class VGG(object):
    ...
    def conv2d_relu(self, prev_layer, layer_idx, layer_name):
        ...
        with tf.variable_scope(layer_name):
            ...
            out = tf.nn.relu(tf.nn.conv2d(prev_layer, W, strides=[1, 1, 1, 1], padding='SAME') + b)
    ...
    def avgpool(self, prev_layer, layer_name):
        ...
        """
        out = tf.nn.avg_pool(prev_layer, ksize=[1, 2, 2, 1], strides=[1, 2, 2, 1], padding='SAME', name=layer_name)
        setattr(self, layer_name, out)
